...
artt = """
 ...
 ▀▄   █       █     ▀▄ █▀ ▀▄  █  ▄▀ █ █  █   █ 
   █ ▀  \033[37m▄▄▄\033[35m    ▀▀▀▀▄   █   ▀  █▀▀▌  █▄▄█ █▀▀▀  
  ▄ █        ▀▄▄▄▄▀    █▄  ▄▀ █  █  █  █ █     
 █   ▀▄                ▀███▀    █      █  █  \033[37m[\033[35m+\033[37m] By \033[37m@CYBROGSCCS\033[35m
  ▀                            ▀      █    ▀    [\033[37m+\033[35m] Special thanks \033[35m@CYBROGS
                                    ▀         
"""
os.system('clear || cls')
print ("\033[35m" + artt)
            ...
            while ccl != ccln:
                if len(cc[ccl]) == 28 and "|" not in str(cc[ccl])[0:14] and "|" not in str(cc[ccl])[26:28] :
                    if cc[ccl] not in ccp:
                        ...
                        if clord == 0:
                            clord = 1
                            print(clorr1 + str(cnter) + clorr2 + "|" + clorr1 + chanil + clorr2 + "|" + clorr1 + "BECYBERS" + clorr2 + "|" + clorr1 + "CYBROGSCCS" + clorr2 + "|" + clorr1 + "CYBROGS")
                        elif clord == 1:
                            clord = 0
                            print(clorr2 + str(cnter) + clorr1 + "|" + clorr1 + chanil + clorr2 + "|" + clorr2 + "BECYBERS" + clorr1 + "|" + clorr2 + "CYBROGSCCS" + clorr1 + "|" + clorr2 + "CYBROGS")
